...
static S_JAM: &[MicroOp] = &[m(B::ReadPC1, I::JamHalt)];
...
pub static OPCODE_SEQUENCES: [&[MicroOp]; 256] = [
    // 0x00-0x0F
    S_BRK, S_ORA_INDX, S_JAM, S_SLO_INDX, EMPTY, S_ORA_ZP, S_ASL_ZP, S_SLO_ZP, S_PHP, S_ORA_IMM, S_ASL_A, EMPTY, EMPTY,
    ...
    S_RTI, S_EOR_INDX, S_JAM, S_SRE_INDX, EMPTY, S_EOR_ZP, S_LSR_ZP, S_SRE_ZP, S_PHA, S_EOR_IMM, S_LSR_A, EMPTY,
    ...
    S_RTS, S_ADC_INDX, S_JAM, S_RRA_INDX, EMPTY, S_ADC_ZP, S_ROR_ZP, S_RRA_ZP, S_PLA, S_ADC_IMM, S_ROR_A, EMPTY,
